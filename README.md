...
| Press Release | [Link to Press Release](https://github.com/srahman05/DS-4320-Project-2/blob/3f3cae23862e636213c0d7f6e651cb670381c70e/press-release.md) |
...
* **General Problem:** Wildfires in the western United States have become increasingly more frequent and destructive, making it difficult for emergency managers to allocate resources effectively before fires occur.
...
### Motivation
Wildfires in the western United States have grown significantly in frequency and severity over the past two decades. Early identification of high-risk conditions can help emergency responders allocate resources before a fire starts rather than after. A risk model built on publicly available wildfire and weather data could support more proactive decision-making at the local and regional levels.

### Rationale
The general problem of predicting wildfire risk is too broad to solve without narrowing the geographic area and defining what "risk" means in measurable terms. Focusing on the western United States makes sense because that region has the most complete historical fire data and the most pressing need. Defining risk as the probability of fire occurrence in a given area based on observable conditions makes the problem more concrete and potentially solvable with available data.

### Press Release Headline and Link
[**Seeing Wildfires Coming: Using Data to Get Ahead of the Crisis**](https://github.com/srahman05/DS-4320-Project-2/blob/3f3cae23862e636213c0d7f6e651cb670381c70e/press-release.md)
...
### Background Summary
This project lives at the intersection of environmental science, public policy, emergency response, and data science. Wildfires are a growing crisis in the western United States driven by climate change, drought, vegetation buildup, and human activity that have all made fires more frequent and more destructive over time. The consequences include communities being displaced, air quality dropping, and properties being destroyed. Local governments and emergency responders face hard decisions every fire season about where to send resources, which areas need evacuation plans, and how to prepare before conditions turn dangerous. All of those decisions depend on knowing where fire risk is highest, and right now most governing agencies do not have solid tools to answer that question before a fire starts. This project uses publicly available data to build a predictive model of wildfire risk that is meant to support the people making those calls on the ground.
